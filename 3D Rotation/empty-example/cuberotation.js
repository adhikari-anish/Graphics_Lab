...
function rotationCallZ() {
  ...
  // x-axis rotation
  transformationMatrix[1][1] = cos(degree);
  transformationMatrix[1][2] = -sin(degree);
  transformationMatrix[2][1] = sin(degree);
  transformationMatrix[2][2] = cos(degree);

  // y-axis rotation
  // transformationMatrix[0][0] = cos(degree);
  // transformationMatrix[0][2] = sin(degree);
  // transformationMatrix[2][0] = -sin(degree);
  // transformationMatrix[2][2] = cos(degree);

  // z-axis rotationCall
  // transformationMatrix[0][0] = cos(degree);
  // transformationMatrix[0][1] = -sin(degree);uj
  // transformationMatrix[1][0] = sin(degree);
  // transformationMatrix[1][1] = cos(degree);
